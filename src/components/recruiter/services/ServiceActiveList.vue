<template>
  <section class="sal-section">
    ...
    <div class="sal-list">
      <div v-for="svc in services" :key="svc.id" class="sal-item group">
        <div class="sal-item-left">
          <div class="sal-svc-info">
            ...
            <div>
              ...
              <p class="sal-desc">{{ svc.description }}</p>
            </div>
          </div>
        ...
        <div class="sal-item-right">
          <span class="sal-status">Đang chạy</span>
...
export interface ActiveService {
  ...
  icon: string; remaining: string; expireDate: string
}
...
.sal-divider { width: 1px; height: 32px; background: #e2e8f0; }
